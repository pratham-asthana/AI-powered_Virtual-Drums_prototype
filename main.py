...
def main():
    ...
    while cap.isOpened():
        ...
        # Flip the frame horizontally (X-axis)
        ...
        if results.multi_hand_landmarks:
            for hand_id, hand_landmarks in enumerate(results.multi_hand_landmarks):
                ...
                # Check for drum hits using the index finger tip landmark
                index_finger_tip = hand_landmarks.landmark[hand_tracker.mp_hands.HandLandmark.INDEX_FINGER_TIP]
                hits = drum_kit.is_hit(hand_id, index_finger_tip, frame_width, frame_height)
